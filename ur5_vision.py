...
class ur5_vision:
    ...
    def find_contours_sharpe(src_image):
        ...
        # this two values need to changed according the scene
        threshold = 126
        max_value = 225
    ...
    ### draw selected contour and center of the contour
    ...
    def image_callback(self,msg):
        ...
        contours, hierarchy = find_contours_sharpe(image)

        #find the child contonur on top of white paper
